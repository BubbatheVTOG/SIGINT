...
# --- Syntax Highlighting Guard (PLACE AT THE VERY BOTTOM) ---
# This prevents the "invalid subscript range" error
if (( ${+ZSH_HIGHLIGHT_STYLES} )); then
    ZSH_HIGHLIGHT_STYLES[command]="fg=#00ff99,bold"
    ZSH_HIGHLIGHT_STYLES[alias]="fg=#00ff99"
    ZSH_HIGHLIGHT_STYLES[path]="fg=#33ccff"
    ZSH_HIGHLIGHT_STYLES[function]="fg=#00ff99"
    ZSH_HIGHLIGHT_STYLES[string]="fg=#33ccff"
fi
